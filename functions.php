 ...
 */
function git_log(){
	$log = executeCommand('git log -3  --graph --abbrev-commit --decorate --all --pretty=format:"<strong class="color1">%d%n</strong> <strong><a href="?diff=%h^!">%h</a></strong> <strong class="color3">%an</strong> <a href="?checkout_c=%h">-></a> <span class="color5">%aD</span> (%ar)<strong class="color1">%n</strong> <span class="color4">%s</span>"');
	show('LOG',$log[0],$log);
}
